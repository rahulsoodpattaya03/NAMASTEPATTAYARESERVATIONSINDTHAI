...
(function () {
  ...
  // Raju Guide — AI virtual guide chat widget (calls the secure n8n endpoint; Raju Guide answers from the catalog).
  function injectConcierge() {
    try {
      ...
      add('bot','Namaste! \uD83D\uDE4F Ask me anything — I am Raju Guide, your virtual guide in Pattaya. Clubs, food, hotels, rentals, spa, tours and more.');
